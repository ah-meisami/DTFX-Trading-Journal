...
<!-- -------------------------------------------------------------------------------------------------------------------------------------------------------- -->
| `-` | fxFactory | `MON` | `TUE` | `WED` | `THU` | `FRI` | `Weekly Profile` |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| :notebook: | [`?week=jul13.2024`](https://www.forexfactory.com/calendar?week=jul13.2024) | [`jul15-xu-long`](#jul15-xu-long) | `-` | `-` | `-` | `-` | `-` |
...
___
## `jul15-xu-long`
![DTFX](https://www.tradingview.com/x/W6gesMSz/ "DTFX")
