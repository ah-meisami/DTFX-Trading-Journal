...
| [:notebook:](#wProfile-jul13) | [`?week=jul13.2024`](https://www.forexfactory.com/calendar?week=jul13.2024) | [`jul15-l`](#jul15-l) | `-` | [`jul17-s`](#jul17-s) :gem: | [`jul18-s`](#jul18-s) :gem: | `-` |  
...
___
## `jul18-s` 
## Supportive Move (doing its job to horrify retail-traders)
![DTFX](https://www.tradingview.com/x/dfJk2fJS/ "DTFX")
## Direct Move (it has smart money support so there is a stronger move than CSS in 50% of the POI)
