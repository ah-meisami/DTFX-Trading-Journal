...
## `apr15`
| Tips | Comments | |
| 🔴 `Price > Time` | `after HTF bias is determined,` <br/> `the market sells off at 10:00 & 12:00 & 13:00,` <br/> `without attending to ICT timing,` <br/> `until market enters to next HTF Support area.` |
| 🔴 `Target > Entry` | `so based on these parameters,` <>br/` it is important to specify the Position Size & targets,` <br/> `base on HTF cycle.`|

| Time | Comments |
| :---: | :--- |
|`10:00` | ![img](https://www.tradingview.com/x/vDxI8i96/ "img") |
___    
## `apr16`
___    
## `apr17`
